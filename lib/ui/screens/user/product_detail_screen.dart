...
import 'package:techgear/models/group_product_specs.dart';
import 'package:techgear/models/product.dart';
import 'package:techgear/models/product_item.dart';
import 'package:techgear/models/product_specification.dart';
...
import 'package:techgear/ui/widgets/color_variant_box.dart';
import 'package:techgear/ui/widgets/specs_variant_box.dart';
  ...
  void groupProductItemsBySpecs() {
    ...
    for (var spec in productSpec.specs) {
      for (var entry in spec.entries) {
        ...
        // Tạo khóa duy nhất cho danh sách VariantValue
